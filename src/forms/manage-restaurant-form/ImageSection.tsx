        ...
        <div className="space-y-2">
            ...
            <div className="flex flex-col gap-8 md:w-[50%]">
                ...
                <FormField control={control} name="imageFile" render={({ field }) => (<FormItem>
                    <FormControl>
                        <Input className="bg-white hover:cursor-pointer" type="file" accept=".jpg, .jpeg, .png" onChange={(event) => field.onChange(event.target.files ? event.target.files[0] : null)} />
                    </FormControl>
                    <FormMessage />
                </FormItem>)}></FormField>
            </div>
